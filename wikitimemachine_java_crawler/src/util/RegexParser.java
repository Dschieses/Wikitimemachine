...
public class RegexParser {
	...
	{
		// a century is 100 years. The mean is the difference between 2 centuries divided by 2 and multiplied with 100, for a better implementation only *50 is executed
	...
	public int matchDate2(String input){
			for(int i=0;i<regExCategory.size();i++){
				...
				for(String regex:regExCategory.get(i)){
					if(input.matches(regex)){
						...
						switch(i){
						case 0: return parseYearAD();
							
						case 1: return parseYearBC();
							
						case 2:return parseCenturyADtoYear();
							
						case 3:return parseCenturyBCtoYear();
							
						case 4:return parseMillenniumADtoYear();
							
						case 5:return parseMillenniumBCtoYear();
							
						case 6:return parseCenturyADRangetoYear();
							
						case 7:return parseCenturyBCRangetoYear();
							
						case 8:return parseCenturyBCADRangetoYear();
							
						case 9:return parseMillenniumADRangetoYear();
							
						case 10:return parseMillenniumBCRangetoYear();
							
						case 11:return parseMillenniumBCADRangetoYear();
						}
						}
					}
				}
